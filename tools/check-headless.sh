...
grep -q "smw-runtime: level=105 layer1_objects=92 layer2_objects=0 layer2_bg=1 map16_tiles=1476 collision_rects=25 slope_surfaces=42 coin_pickups=4" "$LOG_FILE"
