...
grep "smw-debug-state: tag=step_done" "$LOG_FILE" | grep -q "max_x=4735.06"
grep -q "smw-runtime: player_death level=105 cause=hurt count=1 lives=4 x=4735.06" "$LOG_FILE"
