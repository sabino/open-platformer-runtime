...
grep -q "smw-runtime: level=1CB layer1_objects=16 layer2_objects=0 layer2_bg=1 map16_tiles=585 collision_rects=12 slope_surfaces=0 pipe_cells=0/0/0 coin_pickups=7" "$LOG_FILE"
