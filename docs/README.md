...
- [Experimental Godot .NET Web export](WEB-DOTNET-PROTOTYPE.md) covers the custom `godotengine/godot#106125` export track.
...
- [Reference notes](REFERENCE.md) records detailed runtime/importer findings and implementation notes.
- [Physics notes](PHYSICS.md) summarizes the current player-physics bridge and known approximations.
- [Native-unit physics reference](PHYSICS-REFERENCE.md) captures native-unit physics notes and future work.
- [High-level plan](PLAN.md) keeps the implementation plan.

For a public release, `STATUS.md` and `RELEASE-HYGIENE.md` are the most important documents to keep accurate.
