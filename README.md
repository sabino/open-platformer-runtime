...
- ROM validation and deterministic extraction for level `105` by default. A first native C# extractor slice now directly extracts and verifies core ROM assets used by the runtime: GFX32/GFX33, raw SPC upload banks, and global Map16.
